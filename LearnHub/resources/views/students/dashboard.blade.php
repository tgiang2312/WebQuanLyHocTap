...
@section('title', 'Bảng điều khiển Học viên - LearnHub')

@section('content')
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="fw-bold">Bảng điều khiển Học viên</h1>
    </div>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="progress" style="height: 8px;">
                                            <div class="progress-bar bg-primary continue-progress-bar" 
                                                 role="progressbar" 
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('students.courses') }}" class="text-decoration-none text-primary">
            Xem tất cả
        </a>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.continue-progress-bar, .course-progress-bar').forEach(function(bar) {
